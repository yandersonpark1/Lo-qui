...
Status Update will be on 12/01 Monday of Week 14 at this point we should have initial users able to send messages to one another (not 
necessarily worried about concurrency)
